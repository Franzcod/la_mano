...
import 'package:la_mano/src/styles/buttons.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      padding: EdgeInsets.only(
        top: (pressed) ? BaseStyles.listFieldVerticall + BaseStyles.animationOffset  : BaseStyles.listFieldVerticall,
        bottom: (pressed) ? BaseStyles.listFieldVerticall -  BaseStyles.animationOffset  : BaseStyles.listFieldVerticall,
        left: 0,
        right: 0
      ),
      ...
      child: GestureDetector(
          ...
          child: Center(
            child: Text(widget.buttonText, style: fontStyle)
